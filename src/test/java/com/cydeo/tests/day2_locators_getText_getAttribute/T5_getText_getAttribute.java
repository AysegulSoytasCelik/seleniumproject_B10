...
public class T5_getText_getAttribute {
    public static void main(String[] args) {
        ...
        //we are locating the web element using "name" 

        WebElement fistNameInput = driver.findElement(By.name("firstname"));
        ...
        String actualPlaceHolder = fistNameInput.getAttribute("placeholder");
